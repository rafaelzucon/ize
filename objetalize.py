    ...
    def deserialize(self, text: str, c: int):
        ...
        for key in payload:
            ...
            if "dict" in str(type(payload[i] if "list" in str_type_payload else payload[key])) or "list" in str(
                ...
                #print(txt_tab + str(self.type_obj(str(type(payload[i] if "list" in str_type_payload else payload[key])))))
                ...
                #print(txt_tab + '"' + str(payload[i] if "list" in str_type_payload else payload[key]) + '"')
            i = i + 1
